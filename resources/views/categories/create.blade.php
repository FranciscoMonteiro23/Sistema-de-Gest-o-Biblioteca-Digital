...
@section('title', 'Adicionar Categoria - Biblioteca Digital')
...
<div class="bg-white rounded-lg shadow-xl p-8">
    <h1 class="text-3xl font-bold text-gray-800 mb-6">
        <i class="fas fa-plus-circle text-indigo-600"></i> Adicionar Nova Categoria
    </h1>
